...
function Hero() {
  return (
    <div className='flex bg-gray-100  min-h-[100vh] justify-between items-center p-8 md:p-16 relative'>

      <div className='flex flex-col justify-center  items-start gap-4 '>
        <h1 className='text-gray-950 text-3xl md:text-6xl  max-w-[20em] md:max-w-[8em] font-bold '>Podigni svoj Restoran na viši nivo.</h1>
        <p className='text-gray-500  font-normal text-sm md:text-base max-w-[20em]'>Naše istraživanje je pokazalo da čak oko 80% najpopularnijih restorana pripisuju veliki deo svoga uspeha izgradnji profesionalnog
          websajta. </p>
      ...
      <div className='md:flex hidden justify-center w-1/2  items-center'>
