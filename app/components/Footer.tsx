    ...
    <div className={` flex bottom-0  w-full  bg-gray-950 justify-between gap-4 items-center p-4 text-sm mt-auto`}>
      ...
      <div className='flex justify-center  items-center gap-4'>
        <Link href={'https://www.instagram.com/web.restoran/'} className='flex  justify-center items-center '>
          <svg xmlns="http://www.w3.org/2000/svg" className="w-6 stroke-gray-600" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#2c3e50" fill="none" strokeLinecap="round" strokeLinejoin="round">
