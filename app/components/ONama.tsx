        ...
        <div className='flex justify-center gap-8 items-start p-16 flex-col'>
            ...
            <div className='flex justify-between px-4  items-center w-full '>
                <p className='text-gray-500 text-lg max-w-[30em]'>
                    Što se nas tiče, moramo da vam odamo jednu tajnu... <strong className='text-gray-800'>Imamo samo 18 godina.</strong>
                    <br />
                    <br />
                    Naš tim sastoji se iz svega dvoje ljudi, od kojih je jedan zadužen za izradu web sajtova, a drugi za marketing.
                    <br />
                    <br />
                    Ne želimo da se pravimo da smo neka ogromna firma, jer vama to <strong className='text-gray-800'> u suštini i ne treba.</strong>
                    <br />
                    <br />
                    Vama samo trebaju ljudi koji zaista žele da vam ponognu da <strong className='text-gray-800'> ostvarite svoj cilj </strong>, pre nego da vam samo uzmu novac, i prekopiraju tudji sajt čisto da bi vas 'otarasili'.
                </p>
