    ...
    return (
        <div className='md:p-16 p-8 pt-24 md:pt-24  gap-8  md:gap-16 flex flex-col justify-center items-center w-full text-gray-200 bg-gray-950 relative z-10'>
            ...
            <div className='grid grid-cols-[repeat(4,_minmax(240px,_1fr))] gap-8 w-full  items-start justify-start md:overflow-hidden md:overflow-x-hidden overflow-x-scroll overflow-y-hidden '>
                <DeoGrida d={.2} h={'Responzivan Dizajn.'} p='Čak 71% interneta se odvija na mobilnim telefonima.Naši sajtovi su veoma prilagodjeni mobilnoj trafici.' img={phone} />
                <DeoGrida
                    d={.4}
                    h='Izrada sajtova po zelji.'
                    p='U koliko vam se bilo šta na sajtu ne svidi, mi to promenimo.Ako zelite nesto da dodate, na raspolaganju smo.' img={lapTop} />
                <DeoGrida
                    d={.6}

                    h='Optimizacija za kupce.'
                    p='Na internetu, svaki sekund je bitan. Trudimo se da naši sajtovi rade brze od drugih.' img={japanac} />
                <DeoGrida
                    d={.8}
            ...
            <div className='flex flex-col gap-16 w-full px-4'>
                <Kontent img={meeting} h='Besplatna procena sajta' p={'U koliko vam treba sajt, a ne znate koliko bi koštao,kakav bi bio, kakve vrste sajtova su sada popuarne itd.,možete kod nas da zakažete besplatan petanaestominutni sastanak u kom ćete dobiti odgovor na sva vaša pitanja.'} />
