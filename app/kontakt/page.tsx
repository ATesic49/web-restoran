...
function page() {
    ...
    return (
        <div className='flex py-8 flex-col justify-center gap-8 items-center min-h-screen  overflow-hidden relative text-gray-950'>
            ...
            <div className={`-my-4 text-green-500 `}>{status}</div>
            <div className='grid text-white grid-cols-2 relative gap-x-16 gap-y-8 bg-gradient-to-tr from-blue-400 to-pink-200 p-8 pb-4 rounded shadow-lg shadow-blue-200'>
                ...
                <div className='w-full  flex flex-col gap-4 '>
                    <div className='flex flex-col justify-start items-start gap-1'>
                        ...
                        }} type="text" className='p-2 rounded text-sm outline-none w-[20em] text-gray-500 ' />
                    </div>
                    <div className='flex flex-col justify-start items-start gap-1'>
                        <p className='text-sm'>Email:</p>

                        <input type="text" className='p-2 rounded text-sm outline-none w-[20em] text-gray-500' onChange={e => {
                            setEmailState({
                                ...emailState,
                ...
                <div className='w-full flex flex-col gap-1 '>
                    ...
                    <textarea
                        ...
                        name="" className='w-full rounded h-full outline-none  text-sm p-2 text-gray-500' id="" defaultValue={''}></textarea>
                </div>
