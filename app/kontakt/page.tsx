...
function page() {
    ...
    return (
        <div className='flex py-8 flex-col justify-center gap-8 items-center min-h-screen   relative bg-gray-950 text-gray-400 z-10 overflow-hidden pt-24'>
            ...
            <h1 className='text-4xl text-gray-400 font-bold'>Pozovi nas, ili zakazi sastanak</h1>
            <div className={`-my-4 text-green-500 `}>
                {status === 'circ' ? <CircularProgress /> : <>{status}</>}
            </div>
            <div className='grid text-white grid-cols-2 relative gap-x-16 gap-y-8 bg-gradient-to-tr from-blue-500 to-pink-300 p-8 pb-4 rounded shadow-md shadow-blue-950'>
                <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[calc(100%_-_2rem)] w-[1px] bg-gray-300'></div>
                <div className='w-full  flex flex-col gap-4 '>
                    <div className='flex flex-col justify-start items-start gap-1'>
                        ...
                        }} type="text" className='p-2 rounded text-sm outline-none w-[20em] text-gray-600 bg-gray-200' />
                    </div>
                    <div className='flex flex-col justify-start items-start gap-1'>
                        <p className='text-sm'>Email:</p>

                        <input type="text" className='p-2 rounded text-sm outline-none w-[20em] text-gray-600 bg-gray-200' onChange={e => {
                            setEmailState({
                                ...emailState,
                ...
                <div className='w-full flex flex-col gap-1 '>
                    ...
                    <textarea
                        ...
                        name="" className='w-full rounded h-full outline-none  text-sm p-2 text-gray-600 bg-gray-200' id="" defaultValue={''}></textarea>
                </div>
                <div className='px-4 col-span-2 cursor-pointer py-2 rounded  ml-auto text-gray-800 text-sm w-fit -mt-4 bg-gray-50   ' onClick={handleSubmit}> Pošalji</div>
            </div>
